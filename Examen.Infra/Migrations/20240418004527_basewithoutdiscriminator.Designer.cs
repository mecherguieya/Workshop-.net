...
namespace Examen.Infra.Migrations
{
    ...
    [Migration("20240418004527_basewithoutdiscriminator")]
    partial class basewithoutdiscriminator
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Examen.ApplicationCore.Domain.Locataire", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Locataire");
